...
public class ActivitySplash extends ActivityBasic {
...
//        MobileAds.initialize(ActivitySplash.this);
    ...
    public void setListener() {
        this.mFadeIn.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ActivitySplash.this.mImageView.startAnimation(ActivitySplash.this.mFadeInScale);
            }
        });
        this.mFadeInScale.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                                ...
                                Intent intent = new Intent(ActivitySplash.this, ActivityMainScreen.class);
