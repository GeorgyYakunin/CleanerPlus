...
import com.fchatnet.cleaner.utils.FragmentArgs;
import com.fchatnet.ramboost.R;

public class FragmentContainerActivityBasicBackSwipe extends ActivityBasicBackSwipe {
    public static void launch(Activity activity, Class<? extends Fragment> clazz, FragmentArgs args) {
        Intent intent = new Intent(activity, FragmentContainerActivityBasicBackSwipe.class);
    ...
    public static void launchForResult(Fragment fragment, Class<? extends Fragment> clazz, FragmentArgs args, int requestCode) {
        if (fragment.getActivity() != null) {
            Intent intent = new Intent(fragment.getActivity(), FragmentContainerActivityBasicBackSwipe.class);
            intent.putExtra("className", clazz.getName());
            if (args != null) {
                intent.putExtra("args", args);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_ui_container);
        if (fragment != null) {
